...
<!-- Generated from skills/agent-grid-sandboxed/SKILL.md by scripts/build-mirror.sh — do not edit directly. -->
...
Read [MCP edit workflow](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-sandboxed/references/edit-workflow.md) before you change content.
...
Read [MCP tools](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-sandboxed/references/mcp-tools.md) for exact parameters. Read [workflows](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-sandboxed/references/workflows.md) for sequences.

Read [troubleshooting](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-sandboxed/references/troubleshooting.md) when an MCP operation fails.
