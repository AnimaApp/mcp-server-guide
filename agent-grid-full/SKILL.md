...
<!-- Generated from skills/agent-grid-full/SKILL.md by scripts/build-mirror.sh — do not edit directly. -->
...
Read [Git workflow](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-full/references/git-workflow.md) before you use the Git remote.
...
Read [MCP tools](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-full/references/mcp-tools.md) for exact parameters. Read [workflows](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-full/references/workflows.md) for sequences.

Read [troubleshooting](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/agent-grid-full/references/troubleshooting.md) when a tool or Git operation fails.
