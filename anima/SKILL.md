...
<!-- Generated from skills/anima/SKILL.md by scripts/build-mirror.sh — do not edit directly. -->
...
Use `artifact-get_git_token` for very large repositories or full git workflows. See [Git workflow](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/anima/references/git-workflow.md).
...
- [Setup and authentication](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/anima/references/setup.md)
- [Full MCP tool reference](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/anima/references/mcp-tools.md)
- [Git workflow](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/anima/references/git-workflow.md)
- [Worked examples](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/anima/references/workflows.md)
- [Troubleshooting](https://github.com/AnimaApp/mcp-server-guide/blob/main/skills/anima/references/troubleshooting.md)
